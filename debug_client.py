...
#
# ═══════════════════════════════════════════════════════════════════════
#  LEGACY / НЕ СОПРОВОЖДАЕТСЯ (2026-08-25)
#  Отладочный TUI-клиент времён JSON-протокола. Основной UI — webpanel
#  (services/webpanel, Streamlit) и web_ui модули сервисов.
#  Клиент может работать не с последними фичами протокола (streaming,
#  CERT_SYNC, role-поля HELLO); при необходимости использования — привести
#  к актуальному wire-формату (msgpack binary frames, protocol.py).
# ═══════════════════════════════════════════════════════════════════════
#
