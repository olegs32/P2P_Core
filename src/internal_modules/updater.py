# src/internal_modules/updater.py
# Перенесено из services/updater/service.py — ядерный модуль обновления.
# =============================================================================
...
from src.internal_modules import updater_verify as verify
